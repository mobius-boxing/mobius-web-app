 ...
 *   glue_types.code        varchar(50) NOT NULL, UNIQUE (companyId, code)
...
export const createGlueTypeSchema = (t: Translate) =>
  z.object({
    code: code(t, CODE_MAX, t('glueTypes.code')),
 ...
 * blank it.
 */
export const editGlueTypeSchema = (t: Translate) =>
  createGlueTypeSchema(t)
    .partial()
    .extend({ code: code(t, CODE_MAX, t('glueTypes.code')) });

export type CreateGlueTypeSchema = z.infer<
  ReturnType<typeof createGlueTypeSchema>
>;
