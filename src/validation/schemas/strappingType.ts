 ...
 *   strapping_types.code        varchar(50) NOT NULL, UNIQUE (companyId, code)
...
export const createStrappingTypeSchema = (t: Translate) =>
  z.object({
    code: code(t, CODE_MAX, t('strappingTypes.code')),
 ...
 * blank it.
 */
export const editStrappingTypeSchema = (t: Translate) =>
  createStrappingTypeSchema(t)
    .partial()
    .extend({ code: code(t, CODE_MAX, t('strappingTypes.code')) });

export type CreateStrappingTypeSchema = z.infer<
  ReturnType<typeof createStrappingTypeSchema>
>;
