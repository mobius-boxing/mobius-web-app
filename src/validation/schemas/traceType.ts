 ...
 *   trace_types.code        varchar(50) NOT NULL, UNIQUE (companyId, code)
...
export const createTraceTypeSchema = (t: Translate) =>
  z.object({
    code: code(t, CODE_MAX, t('traceTypes.code')),
 ...
 * blank it.
 */
export const editTraceTypeSchema = (t: Translate) =>
  createTraceTypeSchema(t)
    .partial()
    .extend({ code: code(t, CODE_MAX, t('traceTypes.code')) });

export type CreateTraceTypeSchema = z.infer<
  ReturnType<typeof createTraceTypeSchema>
>;
