...
const PaperSupplies: React.FC = () => {
  ...
  const canEdit = has('supplies.edit');
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('paperSupplies.searchPlaceholder')),
      ...columnFilterDefs('supplies', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="gd-page-title">{t('paperSupplies.title')}</h1>
