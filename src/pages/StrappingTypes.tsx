...
const StrappingTypes: React.FC = () => {
    ...
    historyColumn('strapping_types', t),
    {
      ...
      render: (value: any, strappingType: StrappingType) => (
        <div className="flex items-center space-x-2">
          {canEdit && (
            <ActionButton
              label={t('strappingTypes.editStrappingType')}
          ...
          {canEdit && (
            <ActionButton
              label={t('strappingTypes.deleteStrappingType')}
              tone="danger"
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('strappingTypes.searchPlaceholder')),
      ...columnFilterDefs('strapping-types', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
