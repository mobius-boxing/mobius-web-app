...
const Complements: React.FC = () => {
    ...
    historyColumn('complements', t),
    {
      ...
      render: (value: any, complement: Complement) => (
        <div className="flex items-center space-x-2">
          {canEdit && (
            <ActionButton
              label={t('complements.editComplement')}
          ...
          {canEdit && (
            <ActionButton
              label={t('complements.deleteComplement')}
              tone="danger"
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('complements.searchPlaceholder')),
      ...columnFilterDefs('complements', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
