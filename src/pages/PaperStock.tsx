...
const PaperStockPage: React.FC = () => {
  ...
  const canEdit = has('paper-stock.edit');
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('paperStock.searchPlaceholder')),
      ...columnFilterDefs('paper-stock', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
