    ...
    historyColumn('machine_types', t),
    {
      ...
      render: (_: any, mt: MachineType) => (
        <div className="flex items-center space-x-2">
          {canEdit && (
            <ActionButton
              label={t('machineTypes.editTitle')}
              onClick={() => {
                setSelected(mt);
          ...
          {canEdit && (
            <ActionButton
              label={t('machineTypes.deleteTitle')}
              tone="danger"
        ...
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200">
          <div className="p-6">
            {!loading && machineTypes.length === 0 ? (
              ...
              <>
                <Table columns={columns} data={machineTypes} loading={loading} listId="machine-types" />
