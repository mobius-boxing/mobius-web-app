...
const ConsumableStockPage: React.FC = () => {
  ...
  const canEdit = has('consumable-stock.edit');
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('consumableStock.searchPlaceholder')),
      ...columnFilterDefs('consumable-stock', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="gd-page-title">{t('consumableStock.title')}</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200">
          <div className="p-6">
            ...
            {!loading && consumableStock.length === 0 ? (
