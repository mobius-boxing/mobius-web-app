...
const ProductTypes: React.FC = () => {
  ...
  const canEdit = has('product-types.edit');
    ...
    historyColumn('product_types', t),
    {
      ...
      render: (value: any, item: ProductType) => (
        <div className="flex items-center space-x-2">
          {canEdit && (
            <ActionButton
              label={t('productTypes.editProductType')}
          ...
          {canEdit && (
            <ActionButton
              label={t('productTypes.deleteProductType')}
              tone="danger"
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('productTypes.searchPlaceholder')),
      ...columnFilterDefs('product-types', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="gd-page-title">{t('productTypes.title')}</h1>
