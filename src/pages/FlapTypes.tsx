...
const FlapTypes: React.FC = () => {
  ...
  const canEdit = has('flap-types.edit');
    ...
    historyColumn('flap_types', t),
    {
      ...
      render: (value: any, flapType: FlapType) => (
        <div className="flex items-center space-x-2">
          {canEdit && (
            <ActionButton
              label={t('flapTypes.editFlapType')}
          ...
          {canEdit && (
            <ActionButton
              label={t('flapTypes.deleteFlapType')}
              tone="danger"
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('flapTypes.searchPlaceholder')),
      ...columnFilterDefs('flap-types', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="gd-page-title">{t('flapTypes.title')}</h1>
