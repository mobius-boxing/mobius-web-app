...
const PaperTypes: React.FC = () => {
  ...
  const canEdit = has('paper-types.edit');
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('paperTypes.searchPlaceholder')),
      ...columnFilterDefs('paper-types', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="gd-page-title">{t('paperTypes.title')}</h1>
