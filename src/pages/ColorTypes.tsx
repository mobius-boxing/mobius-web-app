...
const ColorTypes: React.FC = () => {
  ...
  const canEdit = has('color-types.edit');
    ...
    historyColumn('color_types', t),
    {
      ...
      render: (value: any, colorType: ColorType) => (
        <div className="flex items-center space-x-2">
          {canEdit && (
            <ActionButton
              label={t('colorTypes.editColorType')}
          ...
          {canEdit && (
            <ActionButton
              label={t('colorTypes.deleteColorType')}
              tone="danger"
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('colorTypes.searchPlaceholder')),
      ...columnFilterDefs('color-types', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
