...
const Palletizations: React.FC = () => {
  ...
  const canEdit = has('palletizing.edit');
    ...
    historyColumn('palletizations', t),
    {
      ...
      render: (_: any, p: Palletization) => (
        <div className="flex items-center space-x-2">
          {canEdit && (
            <ActionButton
              label={t('palletizations.editPalletization')}
          ...
          {canEdit && (
            <ActionButton
              label={t('palletizations.deletePalletization')}
              tone="danger"
  ...
  const filterDefs = useMemo(
    () => [
      searchFilter(t('palletizations.searchPlaceholder')),
      ...columnFilterDefs('palletizations', columns, t, { companyId: effectiveCompanyId }),
    ],
    // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200">
          <div className="p-6">
            {!loading && palletizations.length === 0 ? (
              ...
              <>
                <Table columns={columns} data={palletizations} loading={loading} listId="palletizations" />
